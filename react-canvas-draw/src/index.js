...
export default class CanvasDraw extends PureComponent {
  ...
  getAverageColor = () => {
    ...
    tempCtx.drawImage(this.canvas.grid, 0, 0, width, height);
    tempCtx.drawImage(this.canvas.drawing, 0, 0, width, height);
    const imageData = tempCtx.getImageData(0, 0, 100, 300);

    console.log({imageData})
    
    const components = imageData.length;
  ...
  savePNG = () => {
    ...
    // let i = canvasTypes.length,
    //     tempCanvas = document.createElement("canvas")
    //     tempCanvas.height=height;
    //     tempCanvas.width=width;
    //     tempCtx = tempCanvas.getContext("2d");
    //  while (i--) {
    //   console.log(canvasTypes[i])
    //   console.log(this.canvas[canvasTypes[i]])
    //   tempCtx.drawImage(this.canvas[canvasTypes[i]], 0, 0, width, height);
    // };
  ...
  //   let backgroundCanvas = this.canvas.grid;
  //   let exportCanvas = this.canvas.drawing;
  //   let drawingContext = exportCanvas.getContext("2d")
  //   let backgroundContext = backgroundCanvas.getContext("2d")
    
  //   backgroundContext.drawImage(exportCanvas, 0, 0)
  //   drawingContext.drawImage(backgroundCanvas, 0, 0);
  //   let exportData = backgroundContext.toDataURL(`image/png`);
